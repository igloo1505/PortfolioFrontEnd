...
const PanaromicImageSection = ({setGallerySectionToDisplay, isInitialView, setIsInitialView, gallerySectionToDisplay}) => {
  ...
  return (
    <div className="gallerySection panoramicImageSection">
